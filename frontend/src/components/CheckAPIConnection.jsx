...
function CheckAPIConnection({ onRetry }) {
  return (
    <VStack alignItems="center" justifyContent="center" space={4} flex={1}>
      <Heading textAlign="center" _dark={{ color: 'white' }} _light={{ color: 'black' }}>Server Connection Error</Heading>
      <Text textAlign="center" _dark={{ color: 'white' }} _light={{ color: 'black' }}>
