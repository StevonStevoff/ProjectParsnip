...
function EditPlantForm(props) {
  ...
  const filterDevices = (aSearchTerm) => {
    if (aSearchTerm === "") {
      ...
      const filtered = devices.filter((device) =>
        device.name.toLowerCase().includes(aSearchTerm.toLowerCase())
      );
  ...
  const filterPlantTypes = (aSearchTerm) => {
    if (aSearchTerm === "") {
      ...
      plantT.name.toLowerCase().includes(aSearchTerm.toLowerCase())
      );
  ...
  const filterPlantProfiles= (aSearchTerm) => {
    if (aSearchTerm === "") {
      ...
      plantp.name.toLowerCase().includes(aSearchTerm.toLowerCase())
      );
